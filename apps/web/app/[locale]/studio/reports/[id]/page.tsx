...
import { formatMoney, oblastName, segmentForLocale } from '@river/i18n';
...
/** A report in the studio: private until published; edit in place, publish, compose feed items with AI. */
      ...
      <div className="space-y-6">
        <Card>
          <dl className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div><dt className="text-ink-500">{dict.report.costs}</dt><dd className="font-semibold">{formatMoney(report.facts.costsGbpMinor, 'GBP', locale)}</dd></div>
        ...
        <Card>
          ...
          ) : <PublishPanel reportId={report.id} t={t} />}
        </Card>

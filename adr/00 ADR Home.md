...
| [[ADR-0006 In-Place Editing with Tiptap]] | Headless Tiptap for inline editing of content blocks and reports | accepted | UI / content |
...
| [[ADR-0010 One App, Two Surfaces]] | Same Next.js image deployed as public `web` and IAP-protected `studio` services | accepted | deployment |
